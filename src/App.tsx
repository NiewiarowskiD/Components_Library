      ...
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-12">
          ...
          <p className="text-slate-500 text-lg">
            A flexible button with custom colors, icons, sizes, and roundness.
          </p>
        </header>
...
function Section({
  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex flex-wrap gap-3 items-center bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        {children}
      </div>
    </div>
  );
