    ...
    <div>
      <Section title="Headers — Layout: Start / Center / End">
        <div className="w-full space-y-4">
          <Header color="#18181B" borderColor="#27272A" layout="start" rounded="lg" shadow="md" height="md">
            <Text content="Start Layout" color="#E4E4E7" size="lg" weight="bold" />
          </Header>
      ...
      <Section title="Headers — Layout: Between / Around / Evenly">
        <div className="w-full space-y-4">
          <Header color="#09090B" borderColor="#27272A" layout="between" rounded="lg" shadow="md" height="md">
            <Text content="Left Item" color="#E4E4E7" size="base" weight="semibold" />
            <Text content="Right Item" color="#E4E4E7" size="base" weight="semibold" />
          </Header>
      ...
      <Section title="Headers — Custom HEX Colors">
        <div className="w-full space-y-4">
          ...
          <Header color="#27272A" borderColor="#3F3F46" layout="center" rounded="lg" shadow="sm" height="md">
            <Text content="Zinc Header" color="#E4E4E7" size="lg" weight="bold" />
          </Header>
      ...
      <Section title="Headers — Height Variations">
        <div className="w-full space-y-4">
          <Header color="#18181B" borderColor="#27272A" layout="center" rounded="lg" shadow="md" height="sm">
            <Text content="Small Height" color="#E4E4E7" size="base" weight="semibold" />
          </Header>
          <Header color="#18181B" borderColor="#27272A" layout="center" rounded="lg" shadow="md" height="lg">
            <Text content="Large Height" color="#E4E4E7" size="xl" weight="bold" />
          </Header>
          <Header color="#18181B" borderColor="#27272A" layout="center" rounded="lg" shadow="md" height="2xl">
            <Text content="Extra Large Height" color="#E4E4E7" size="2xl" weight="extrabold" />
          </Header>
        </div>
      </Section>
      ...
      <Section title="Headers — With Buttons & Text Inside">
        <div className="w-full space-y-4">
          <Header color="#09090B" borderColor="#27272A" layout="between" rounded="lg" shadow="md" height="md">
            <Text content="My App" color="#E4E4E7" size="xl" weight="bold" />
            <Button text="Sign In" color="#10B981" size="sm" name="header-signin" />
          </Header>
          <Header color="#18181B" borderColor="#27272A" layout="between" rounded="lg" shadow="sm" height="md">
            <Text content="Dashboard" color="#E4E4E7" size="xl" weight="bold" />
